 ...
 * @author SOLIDusr
 */
class FaceitKt(private val userName: String, game: Game) {
    ...
    val userObject = FaceitUser(userInfo.get("nickname").toString(), userInfo.get("avatar").toString(),
        userInfo["country"].toString(), userInfo["platforms"], userInfo["memberships"].toString(),
        userInfo["verified"], userInfo["activated_ad"].toString())
    )
